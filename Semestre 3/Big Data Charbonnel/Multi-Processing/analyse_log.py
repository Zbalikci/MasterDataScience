...
pattern_file = re.compile(r'INFO .* =(.*),.* T.*') # pour réupérer le nom de chacun des fichiers
...
if __name__ == "__main__":
    ...
    with open(log_file_name,'r') as file:
        ...
        for i, match in enumerate(matches_file):
            dict[match]=float(matches_temps[i]) # {nom_fichier : temps d'execution du fichier, etc...}
