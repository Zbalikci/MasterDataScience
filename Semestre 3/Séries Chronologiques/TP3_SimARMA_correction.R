...
plot(Decomp)
Res = Decomp$random
# Subtilité : Decomp$random contient des NA en début et fin (dus à la moyenne mobile arithmétique utilisée pour éliminer la saisonnalité)
